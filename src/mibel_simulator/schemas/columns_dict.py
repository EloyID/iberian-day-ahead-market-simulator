...
columns_dict = {
    ...
    cols.FLOAT_FIX_COST_COMPLEX_ORDER:          pa.Column(float                                           ),
    cols.FLOAT_VAR_COST_COMPLEX_ORDER:          pa.Column(float                                           ),
    ...
    cols.IDS_COMPLEX_ORDERS:        pa.Column(object                                   ),
    cols.IDS_PARADOX_GROUPS:        pa.Column(object                                   ),
    cols.PARADOX_GROUPS_COLUMN:     pa.Column(object                                   ),
    ...
    cols.INT_COMPLEX_ORDERS_COUNT:  pa.Column(int, checks=[pa.Check.ge(0)], coerce=True),
    cols.INT_PARADOX_GROUPS_COUNT:  pa.Column(int, checks=[pa.Check.ge(0)], coerce=True),
