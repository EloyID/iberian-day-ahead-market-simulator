...
def filter_paradoxical_orders_from_det_cab(
    det_cab_df: pd.DataFrame,
    paradoxical_orders_to_keep: dict,
    ...
    mic_scos_to_keep = paradoxical_orders_to_keep[cols.IDS_MIC_SCOS]
    bid_blocks_to_keep = paradoxical_orders_to_keep[cols.IDS_BID_BLOCKS]
