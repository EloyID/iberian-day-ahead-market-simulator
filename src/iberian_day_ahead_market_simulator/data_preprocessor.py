...
def get_det_cab_id_paradoxical_order(det_cab: pd.DataFrame) -> np.ndarray:
    """
...
def get_det_cab_for_simulation(
    ...
    det_cab[cols.ID_PARADOXICAL_ORDERS] = get_det_cab_id_paradoxical_order(det_cab)
...
def get_all_paradoxical_orders(det_cab: pd.DataFrame) -> dict:
    """
