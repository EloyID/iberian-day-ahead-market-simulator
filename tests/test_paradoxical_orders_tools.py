...
class TestTransformIdsParadoxicalOrdersListToDict:
    ...
    def test_transform_only_mic_scos(self):
        ...
        result = transform_ids_paradoxical_orders_list_to_dict(ids)
    ...
    def test_transform_empty_list(self):
        ...
        result = transform_ids_paradoxical_orders_list_to_dict([])
    ...
    def test_roundtrip_transformation(self):
        ...
        result_dict = transform_ids_paradoxical_orders_list_to_dict(ids)
...
class TestTransformParadoxicalOrdersDictToIdsList:
    ...
    def test_dict_to_list_preserves_order(self):
        ...
        result = transform_paradoxical_orders_dict_to_ids_list(paradox_dict)
...
class TestCheckAreParadoxicalOrdersTested:
    """Test function for checking if paradox groups have been tested."""

    def test_exact_match_found(self):
        """Test that exact matches are detected."""
        combo1 = transform_ids_paradoxical_orders_list_to_dict(
            ["9706994_SCO", "9707582_B_2_GE_0"]
        )
        combo2 = transform_ids_paradoxical_orders_list_to_dict(
            ["9707198_SCO", "9707925_B_1_GE_0"]
        )
        iterations_df = pd.DataFrame({cols.PARADOXICAL_ORDERS_COLUMN: [combo1, combo2]})

        assert check_are_paradoxical_orders_tested(
    ...
    def test_order_independence(self):
        ...
        combo = transform_ids_paradoxical_orders_list_to_dict(
            ["9706994_SCO", "9707198_SCO", "9707582_B_2_GE_0"]
        )
        iterations_df = pd.DataFrame({cols.PARADOXICAL_ORDERS_COLUMN: [combo]})
    ...
    def test_no_match_different_ids(self):
        ...
        assert not check_are_paradoxical_orders_tested(
    ...
    def test_subset_not_matched(self):
        ...
        assert not check_are_paradoxical_orders_tested(iterations_df, ["9706994_SCO"])
    ...
    def test_empty_iterations_df(self):
        ...
        assert not check_are_paradoxical_orders_tested(iterations_df, ["9706994_SCO"])
        assert not check_are_paradoxical_orders_tested(iterations_df, [])
    ...
    def test_empty_combination(self):
        ...
        assert check_are_paradoxical_orders_tested(iterations_df, [])

    def test_multiple_iterations(self):
        """Test with multiple iterations in the DataFrame."""
        combos = [
            transform_ids_paradoxical_orders_list_to_dict(["9706994_SCO"]),
            transform_ids_paradoxical_orders_list_to_dict(["9707198_SCO", "9708010_SCO"]),
            transform_ids_paradoxical_orders_list_to_dict(["9707582_B_2_GE_0"]),
        ]
        iterations_df = pd.DataFrame({cols.PARADOXICAL_ORDERS_COLUMN: combos})

        assert check_are_paradoxical_orders_tested(iterations_df, ["9706994_SCO"])
        assert check_are_paradoxical_orders_tested(
            iterations_df, ["9707198_SCO", "9708010_SCO"]
        )
        assert check_are_paradoxical_orders_tested(iterations_df, ["9707582_B_2_GE_0"])
        assert not check_are_paradoxical_orders_tested(iterations_df, ["9706993_SCO"])
